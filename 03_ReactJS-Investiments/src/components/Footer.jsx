export default function Footer({atvType = '', module = 0, moduleName = '', date=''}) {
            ...
            <div className="flex flex-col pb-4 border-b border-gray-400">
                <div className="flex flex-row justify-center items-center">
                    <a href="https://github.com/zesy">
                        <img src="https://raw.githubusercontent.com/zesy/zesy/main/_some-imgs/GitHub-Mark-Light-32px.png" alt="github" />
                    </a>
                    <a href="https://github.com/zesy">
            ...
            <div className="flex flex-col items-center justify-center text-center">
                ...
                <div className="flex flex-row items-center justify-center divide-x">
                    ...
                    <div className={moduleClassName}>
                        ...
                        <a href="https://www.igti.com.br" target="_blank" rel="noreferrer"><img src="https://raw.githubusercontent.com/zesy/zesy/main/_some-imgs/igti-logo.png" alt="github" /></a>
                    </div>
                    
                    <div className={moduleClassName}>
                        <p className="text-sm font-semibold">Desenvolvedor React</p>
                        <p className="text-sm">Módulo {module} - {moduleName}</p>
                        <p className="text-sm"><small>{date}</small></p>
                    </div>  
